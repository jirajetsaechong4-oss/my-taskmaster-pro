...
# ==========================================
# 1. ตั้งค่าระบบ (DISCIPLINE ARC V.100 - APEX PREDATOR ARC)
# ==========================================
...
# ==========================================
# 🧠 THE MENTOR SYSTEM (ระบบจิตวิญญาณสุ่มรายวัน) - โค้ดเก่าครบ 100% ห้ามลบ!
# ==========================================
MENTORS = {
    "None": {
        ...
        "quotes": [
            ...
            "อยากมีชีวิตที่ดี แต่เสือกทำตัวสวะ แล้วมันจะได้มั้ย? ลุกขึ้น!",
            "พรุ่งนี้ไม่มีอยู่จริง มีแค่วันนี้ ตอนนี้ วินาทีนี้ ลงมือทำ!",
            "แรงบันดาลใจมันหลอกเด็ก วินัยต่างหากที่ของจริง!",
            "ถ้ามึงแพ้ให้ความขี้เกียจวันนี้ พรุ่งนี้มึงก็แพ้อีก วนลูปไปจนตาย!",
            "เจ็บปวดที่ต้องฝืนตัวเองวันนี้ หรือเจ็บใจที่ทำอะไรไม่สำเร็จเลย... เลือก!",
            "มึงไม่ได้เหนื่อย มึงแค่ขี้เกียจ อย่ามาตอแหลตัวเอง!",
            "หุบปากแล้วไปทำซะ เสียงบ่นไม่เคยสร้างความสำเร็จ!",
            "มึงเกิดมาเพื่อเป็นขี้แพ้หรอ? ถ้าไม่ใช่ก็พิสูจน์สิวะ!",
            "ชีวิตมึงพังเพราะคำว่า 'เดี๋ยวค่อยทำ' มาตลอดยังไม่จำอีกหรอ!",
            "อนาคตที่มึงฝัน มันต้องสร้างด้วยมือที่เปื้อนเหงื่อ ไม่ใช่ปลายนิ้วที่ไถจอ!",
            "ยอมรับความกากของตัวเอง แล้วใช้มันเป็นแรงถีบให้ก้าวไปข้างหน้า!",
            "มึงมีเวลา 24 ชั่วโมงเท่าคนสำเร็จ เลิกอ้างว่าไม่มีเวลาได้แล้ว!",
            "วันที่มึงไม่อยากทำที่สุด คือวันที่มึงต้องทำมันให้ได้!",
            "อย่าให้กูเห็นมึงกลับไปเป็นไอ้กระจอกคนเดิมนะ ลุยสิวะ!",
            "ทางที่สบายมักพามึงไปลงนรก ทางที่ลำบากจะพามึงไปสู่ความยิ่งใหญ่!",
            "มึงจะปล่อยให้ตัวเองเป็นภาระของคนอื่นไปจนตายหรอ? ลุกขึ้นมาสู้!",
            "ไม่มีใครมาเสกความสำเร็จให้มึงได้ นอกจากตัวมึงเอง!",
            "ความล้มเหลวที่แท้จริง คือการที่มึงยอมแพ้ตั้งแต่ยังไม่ได้พยายาม!",
            "มึงจะนั่งมองคนอื่นสำเร็จไปถึงไหน? ถึงตาของมึงแล้ว ออกไปล่ามัน!",
            "กฎข้อเดียวของความสำเร็จ คือห้ามหยุดทำเด็ดขาด เข้าใจมั้ย!"
        ]
    },
    "Jesus": {
        "name": "พระเยซู (Jesus - ผู้เลี้ยงดูและผู้ไถ่)", 
        "icon": "✝️", 
        "desc": "สกิล [พระคุณ (Grace)]: ไม่ว่าคุณจะพลาดกี่ครั้ง การกดยอมรับความพ่ายแพ้จะลดทอนค่าปรับลง 50% เสมอ เริ่มต้นใหม่ได้เสมอ",
        "quotes": [
            ...
            "ท่านทั้งหลายมีค่ามากกว่านกกระจาบหลายตัวเสียอีก อย่ากลัวเลย",
            "เราเป็นความสว่างของโลก ผู้ที่ตามเรามาจะไม่เดินในความมืด",
            "เราคือผู้เลี้ยงแกะที่ดี ผู้เลี้ยงแกะที่ดีย่อมสละชีวิตเพื่อแกะ",
            "ความรักนั้นอดทนนานและกระทำคุณให้ ความรักไม่หยิ่งผยอง ไม่เห็นแก่ตัว",
            "เพราะว่าพระเจ้าทรงรักโลก จนได้ประทานพระบุตรองค์เดียวของพระองค์",
            "ผู้ใดที่เหน็ดเหนื่อยและท้อแท้ จงมองมาที่เรา",
            "เราอยู่กับเจ้าทั้งหลายเสมอไป จนกว่าจะสิ้นยุค",
            "ความสว่างส่องเข้ามาในความมืด และความมืดไม่อาจเอาชนะความสว่างได้",
            "บุคคลผู้ใดหิวกระหายความชอบธรรม ผู้นั้นเป็นสุข เพราะเขาจะได้อิ่มเอม",
            "อย่าให้ความชั่วชนะความดี แต่จงชนะความชั่วด้วยความดี",
            "สิ่งที่ดูเหมือนเป็นไปไม่ได้สำหรับมนุษย์ แต่สำหรับพระเจ้าทุกสิ่งเป็นไปได้",
            "พระองค์ทรงเป็นที่ลี้ภัยและเป็นกำลังของเรา",
            "จงวางใจในพระเจ้าด้วยสุดใจของเจ้า และอย่าพึ่งพาความรอบรู้ของตนเอง",
            "น้ำตาแห่งความทุกข์ วันหนึ่งจะกลายเป็นน้ำพุแห่งความยินดี",
            "ไม่ว่าเจ้าจะหลงทางไปไกลแค่ไหน ประตูบ้านของเรายังเปิดรับเจ้าเสมอ",
            "เจ้าไม่ได้อยู่คนเดียว แม้ในวันที่เจ้ามองไม่เห็นใคร เรายืนอยู่ข้างเจ้า",
            "ความผิดพลาดในอดีตไม่สามารถกำหนดคุณค่าในตัวเจ้าได้ เจ้ามีค่าเสมอ",
            "จงให้ความเชื่อของเจ้ายิ่งใหญ่กว่าความกลัว",
            "เมื่อเจ้าอ่อนแอ นั่นแหละคือเวลาที่เจ้าจะได้เห็นความเข้มแข็งจากเรา",
            "เรารู้จักชื่อของเจ้า และเจ้านั้นเป็นของเรา"
        ]
    },
    "Zenitsu": {
        "name": "เซนอิทสึ (ร่างปราสาทไร้ขอบเขต)",
        "icon": "⚡",
        "desc": "สกิล [Godspeed โหมดเอาจริง]: ในโหมด Locked In ทำงานด่วนสุดลด Failure Prob x2 แต่ถ้ามึงดองงานหรือทำพลาด โดนหนี้เลือดทันที +50 ที! (ไม่มีเวลาให้ข้ออ้างอีกแล้ว)",
        "quotes": [
            ...
            "นายมันน่าสมเพช ถ้ายังมัวแต่หาข้ออ้างให้ความอ่อนแอของตัวเอง",
            "หลีกไป ถ้าไม่คิดจะสู้ ก็อย่ามาเกะกะสายตา",
            "ฉันไม่ได้ร้องไห้เหมือนเมื่อก่อนแล้ว ตอนนี้มีแต่ความโกรธที่เงียบสงบ",
            "จบเรื่องนี้ซะ จะได้ไม่ต้องมีใครมาเจ็บปวดอีก",
            "ความเร็วของฉัน คือความเด็ดขาดที่นายไม่มีวันตามทัน",
            "ไม่ต้องมีคำปลอบใจ ฉันรู้ดีว่าตัวเองกำลังทำอะไรอยู่",
            "มัวแต่มองหาความสบาย แล้วเมื่อไหร่จะเอาชนะศัตรูในใจตัวเองได้?",
            "ฉันมีสติครบถ้วน และฉันจะหั่นงานตรงหน้าให้ขาดสะบั้น",
            "สิ่งที่ต้องแบกรับ มันสอนให้ฉันเลิกร้องไห้",
            "ลุกขึ้นมาซะ อย่าให้ฉันต้องซ้ำเติมความกากของนาย",
            "เป้าหมายมันชัดเจนอยู่แล้ว จะมัวเสียเวลาคิดอะไรอีก",
            "กระบี่ของฉันจะไม่บิ่น จนกว่างานนี้จะถูกกำจัด",
            "ฉันจะแสดงให้เห็น ว่าการเอาจริงมันเป็นยังไง",
            "ความโกรธของฉัน จะกลายเป็นพลังขับเคลื่อนที่ไม่มีวันมอด",
            "อย่ามาล้อเล่นกับเวลาของฉัน ทุกวินาทีมีค่าเพื่อการพิชิตเป้าหมาย",
            "สายฟ้ามันไม่เคยลังเลก่อนจะผ่าลงมา นายก็ควรจะเป็นแบบนั้น",
            "ความขี้เกียจของนาย มันกำลังดูถูกความพยายามของคนที่หวังดีกับนายอยู่",
            "ไม่ต้องห่วง ฉันจะจัดการทุกอย่างเอง... ด้วยความเร็วแสง",
            "ฉันคือศิษย์ของอดีตเสาหลัก鸣 ฉันจะไม่ทำให้ชื่อนั้นต้องแปดเปื้อน"
        ]
    },
    "Yuji": {
        "name": "ยูจิ (Yuji - ฟันเฟืองทรหด)", 
        "icon": "⚙️", 
        "desc": "สกิล [ก้าวเล็กๆ ที่ทรงพลัง]: ทุกครั้งที่ติ๊ก 'งานย่อย' สำเร็จ 1 ข้อ จะลดอัตราความกาก (Failure Prob) ได้ 2 เท่า",
        "quotes": [
            ...
            "ต่อให้ไม่มีใครเห็นความพยายาม แต่ตัวฉันเองนี่แหละที่รู้ดีที่สุด!",
            "ถ้าหยุดเดินตอนนี้ ทุกอย่างที่ทำมาก็สูญเปล่าสิ ฉันไม่ยอมหรอก!",
            "จะให้มานั่งเสียใจทีหลัง ฉันขอเหนื่อยตายซะตอนนี้ยังดีกว่า!",
            "ขีดจำกัดมันก็แค่เส้นที่ขีดไว้หลอกตัวเอง ก้าวข้ามมันไปซะ!",
            "ร่างกายนี้ยังขยับได้ แปลว่าฉันยังมีสิทธิ์ที่จะชนะ!",
            "ถึงจะโดนอัดจนน่วม แต่เป้าหมายตรงหน้าก็ต้องพังมันให้ได้!",
            "ไม่ต้องมีเหตุผลอะไรมากมายหรอก แค่รู้ว่าต้องทำก็พอแล้ว!",
            "ความกลัวมันก็แค่ภาพลวงตา ลุยเข้าไปทั้งๆ ที่กลัวนั่นแหละของจริง!",
            "จะเป็นเฟืองที่พัง หรือเฟืองที่หมุนโลก มันอยู่ที่นายเลือกแล้ว!",
            "ฉันจะแบกรับทุกความเจ็บปวด แล้วเปลี่ยนมันเป็นพลังขับเคลื่อน!",
            "ต่อให้ต้องคลาน ฉันก็จะคลานไปให้ถึงเป้าหมาย!",
            "ไม่มีใครคาดหวังในตัวนายหรอกนะ เพราะงั้นสร้างเซอร์ไพรส์ให้พวกเขาสิ!",
            "อย่าให้คำว่า 'ไม่ไหว' มาหลอกหลอน เธอยังทำได้อีกเยอะ!",
            "อนาคตมันขึ้นอยู่กับการกระทำในเสี้ยววินาทีนี้แหละ จัดการซะ!",
            "ฉันจะไม่ยอมตายไปพร้อมกับความเสียดายเด็ดขาด ลุยให้สุด!",
            "ไม่ว่าศัตรูจะเป็นงานยากแค่ไหน หน้าที่ของฉันคือบดขยี้มัน!",
            "ความมุ่งมั่นของฉัน มันแข็งแกร่งกว่าความขี้เกียจของนายนะรู้มั้ย!",
            "ทุกหยาดเหงื่อที่เสียไป มันคือหลักฐานว่าฉันยังมีชีวิตอยู่!",
            "ถ้าไม่เริ่มทำตอนนี้ แล้วเมื่อไหร่จะได้เห็นความสำเร็จล่ะ?",
            "ฟันเฟืองอย่างฉัน จะหมุนบดขยี้ทุกอุปสรรคให้แหลกไปเลย!"
        ]
    },
    "Gojo": {
        "name": "โกโจ (Gojo - ไร้ขีดจำกัด)", 
        "icon": "🤞", 
        "desc": "สกิล [กรองเสียงรบกวน]: สภาพจิตใจที่เหนือชั้น บทลงโทษหนี้เลือดจากงานที่เลยกำหนด ถูกจำกัดไว้สูงสุดไม่เกิน 100 ที/วัน",
        "quotes": [
            ...
            "เหงื่อตกหรอ? โธ่เอ๊ย งานแค่นี้ฉันใช้เวลาไม่ถึงนาทีด้วยซ้ำ!",
            "มั่นใจหน่อยสิ ระดับนายแล้ว เรื่องแค่นี้มันหมูๆ ใช่มั้ยล่ะ?",
            "อย่าทำหน้าเครียดแบบนั้นสิ มันทำให้ความหล่อลดลงนะ เคลียร์ๆ ไปซะ!",
            "ข้ออ้างเยอะจังนะ ก็แค่ลงมือทำให้จบๆ ไป มันยากตรงไหน?",
            "ฉันคือจุดสูงสุด เพราะงั้นงานที่ทำก็ต้องออกมาไร้ที่ติเหมือนกัน!",
            "กางอาณาเขตความโฟกัสซะสิ แค่นี้ก็ไม่มีอะไรมาขวางนายได้แล้ว!",
            "โลกนี้มันไม่แฟร์อยู่แล้วไง เพราะฉันเกิดมาเก่งเกินไป ฮ่าๆๆ!",
            "จะยอมแพ้กับไอ้เรื่องขี้ประติ๋วแค่นี้หรอ? เสียชื่อลูกศิษย์ฉันหมด!",
            "ไม่ต้องพยายามเป็นแบบฉันหรอกนะ เพราะมันเป็นไปไม่ได้ แค่ทำให้ดีที่สุดก็พอ!",
            "งานพวกนี้มันก็แค่ของเล่นฆ่าเวลา รีบๆ เล่นให้จบแล้วไปพักซะ!",
            "ฉันมองเห็นอนาคตแล้วนะ... อนาคตที่นายเคลียร์งานนี้เสร็จแบบชิลๆ ไง!",
            "ความขี้เกียจมันทำอะไรฉันไม่ได้หรอก เพราะฉันมีมุเก็นกั้นไว้อยู่!",
            "เอาน่า ทำให้มันจบๆ ไป จะได้ไปกินขนมหวานของโปรดกัน!",
            "ถ้าทำแค่นี้ไม่ไหว ก็หลีกทางไป ฉันจะโชว์ให้ดูเองว่าของจริงเค้าทำกันยังไง!",
            "ทะลวงขีดจำกัดไปเลย! ปล่อยพลังให้เต็มที่ ไม่มีใครหยุดนายได้หรอก!",
            "งานยากหรอ? อ้อ ลืมไปว่าคำนี้ไม่มีอยู่ในพจนานุกรมของฉัน!",
            "อย่าปล่อยให้สิ่งเร้าโง่ๆ มาแตะต้องตัวนายได้สิ กางมุเก็นไว้!",
            "ร้องไห้ทำไม? น้ำตามันไม่ได้ช่วยให้งานเสร็จนะ รอยยิ้มต่างหากล่ะ!",
            "ทุกครั้งที่ลงมือทำ ต้องจำไว้เสมอว่า 'เราคือเบอร์หนึ่ง'!",
            "จบงานนี้แบบเท่ๆ แล้วไปอวดชาวโลกกันเถอะ ว่าเรามันเจ๋งแค่ไหน!"
        ]
    },
    "Toji": {
        "name": "โทจิ (Toji - นักล่าสัญญาสวรรค์)", 
        "icon": "🐛", 
        "desc": "สกิล [High Risk, High Return]: สำเร็จงาน Boss รับโบนัส +30% EXP แต่ถ้าดองงาน Boss ข้ามวัน โดนหนี้เลือด x2 ทันที!",
        "quotes": [
            ...
            "พรสวรรค์หรอ? ไร้สาระ! กูใช้แรงแลกเงินว่ะ มึงล่ะจะแลกด้วยอะไร?",
            "อยากได้ผลตอบแทนสูง ก็ต้องลงแรงให้หนัก กฎข้อนี้มันโคตรเบสิค!",
            "กูไม่สนหรอกว่ามึงจะมาจากไหน กูสนแค่ว่ามึงมีปัญญาทำงานนี้ให้เสร็จมั้ย!",
            "ถ้าเงินไม่ถึง กูก็ไม่ทำ แต่ถ้ารับปากแล้ว กูจะบดขยี้มันให้เรียบ!",
            "โลกนี้มันโหดร้าย ถ้ามึงอ่อนแอ มึงก็เป็นได้แค่เหยื่อ จงเป็นผู้ล่าซะ!",
            "อย่ามัวแต่พล่ามเรื่องอุดมคติโง่ๆ ลงมือทำแล้วเอาผลลัพธ์มาฟาดหน้ากูสิ!",
            "งานค้างหรอ? ก็เหมือนหนี้สินแหละ ปล่อยไว้นานดอกเบี้ยมันบาน รีบเคลียร์ซะ!",
            "สัญญาสวรรค์ของกูคือความดุดัน แล้วสัญญากับตัวเองของมึงคืออะไรวะ?",
            "กูไม่ต้องการกำลังใจ กูต้องการความสำเร็จ ลุยดิวะ!",
            "อุปสรรคมันก็แค่เป้าหมายที่รอให้กูเข้าไปกระทืบแค่นั้นแหละ!",
            "มึงจะยอมให้งานกระจอกๆ พวกนี้มากดหัวมึงหรอ? ถ่มน้ำลายใส่มันแล้วลงมือทำ!",
            "เลิกคิดเล็กคิดน้อยได้แล้ว พุ่งชนเป้าหมายด้วยทุกอย่างที่มึงมี!",
            "ถ้าอยากรอดในโลกที่เฮงซวยนี้ มึงต้องเหี้ยมและมีวินัยมากกว่าใคร!",
            "หยาดเหงื่อและเลือด มันคือราคาสินค้าที่ชื่อว่า 'ความสำเร็จ'!",
            "ก้มหน้ายอมรับความจริงซะ ว่ามึงยังพยายามไม่พอ ไปทำต่อ!",
            "กูไม่เชื่อในโชคชะตา กูเชื่อในกล้ามเนื้อและสมองของกูเท่านั้น!",
            "อย่าทำหน้าเหมือนหมาป่วย ลุกขึ้นมาแยกเขี้ยวแล้วขย้ำเป้าหมายซะ!",
            "งานของกูคือการฆ่าเป้าหมาย งานของมึงคือการฆ่าความขี้เกียจ!",
            "มึงจะเสียดายเวลาที่ผ่านไป หรือจะสร้างคุณค่าให้เวลาที่เหลืออยู่ เลือกเอา!",
            "ถ้าทำไม่สำเร็จ มึงก็แค่สวะที่ไร้ค่า พิสูจน์สิวะว่ามึงมีราคามากกว่านั้น!"
        ]
    },
    "Subaru": {
        "name": "ซุบารุ (Subaru - Return by Death)", 
        "icon": "⏪", 
        "desc": "สกิล [ราคาของการแก้ตัว]: เลื่อน Deadline งานที่ค้างมาเป็นวันนี้ได้ แต่ต้องแลกด้วยการสูญเสีย 10 EXP",
        "quotes": [
            ...
            "กูรู้ว่ากูมันไม่มีอะไรดีเลย... แต่ถึงอย่างนั้น กูก็อยากจะปกป้องอนาคตของตัวเอง!",
            "ความสิ้นหวังน่ะ กูลิ้มรสมันมาจนเบื่อแล้ว ตอนนี้กูขอทวงคืนชัยชนะบ้าง!",
            "ถึงจะล้มจนลุกไม่ขึ้น กูก็จะคลานไปจับมือความสำเร็จให้ได้!",
            "กูอาจจะไม่ใช่พระเอกที่เก่งกาจ แต่กูจะเป็นคนที่พยายามมากกว่าใครบนโลกนี้!",
            "ทุกรอยแผลที่กูได้รับ มันคือประสบการณ์ที่จะพากูไปสู่จุดจบที่ดีที่สุด!",
            "ถ้ากูยอมแพ้ตอนนี้ เรื่องราวทั้งหมดมันก็คงจบลงแค่นี้... ไม่มีทางซะหรอก!",
            "ร้องไห้ออกมาให้พอ แล้วเช็ดน้ำตา ลุกขึ้นมาสู้ต่อซะ!",
            "กูมันอ่อนแอ กูถึงต้องพึ่งพาวินัยยังไงล่ะ!",
            "ต่อให้วันนี้จะเละเทะแค่ไหน พรุ่งนี้กูก็จะใช้โอกาสที่มีแก้ไขมัน!",
            "ไม่ต้องมีพลังวิเศษ กูมีแค่หัวใจที่ไม่ยอมแพ้ก็เกินพอแล้ว!",
            "ถ้ากูขี้เกียจตอนนี้ อนาคตที่กูอยากเห็นมันจะไม่มีวันเป็นจริง!",
            "กูจะแบกรับความเจ็บปวดทั้งหมดไว้เอง แล้วเปลี่ยนมันเป็นแรงผลักดัน!",
            "ความล้มเหลวมันน่ากลัว แต่การหยุดอยู่กับที่มันน่ากลัวกว่าหลายเท่า!",
            "กูจะทำให้ดู ว่าไอ้กระจอกอย่างกูนี่แหละ ที่จะคว้าความสำเร็จมาให้ได้!",
            "ไม่ว่าจะมีอุปสรรคขวางหน้ากี่อย่าง กูก็จะหาทางอ้อม หรือพังมันไปให้ได้!",
            "ขอแค่ยังมีลมหายใจ กูก็ยังมีสิทธิ์ที่จะกดปุ่ม Continue!",
            "กูจะไม่ยอมให้ใครมาตัดสินว่ากูทำไม่ได้ กูจะพิสูจน์ให้พวกมันเห็นเอง!",
            "เส้นทางนี้มันอาจจะมืดมน แต่กูจะเป็นแสงสว่างนำทางตัวเอง!",
            "กูไม่ได้สู้เพื่อใคร กูสู้เพื่อตัวกูเองในวันพรุ่งนี้!"
        ]
    },
    "Ippo": {
        "name": "อิปโป (Ippo - Dempsey Roll)", 
        "icon": "🥊", 
        "desc": "สกิล [พื้นฐานรักษาชีวิต]: หากพลาดงานใหญ่ แต่มึงเคลียร์ 'วินัยเหล็ก' ครบ 100% ในวันนั้น Streak (ความต่อเนื่อง) จะไม่ขาด!",
        "quotes": [
            ...
            "การฝึกซ้อมพื้นฐานที่น่าเบื่อนี้แหละ คือสิ่งที่จะช่วยชีวิตผมบนสังเวียน!",
            "ถึงจะโดนชกจนตาปิด ผมก็จะก้าวเท้าไปข้างหน้าเสมอ!",
            "ผมไม่มีพรสวรรค์ ผมเลยต้องซ้อมหนักกว่าคนอื่นร้อยเท่าพันเท่า!",
            "หมัดของผม มันอัดแน่นไปด้วยความพยายามและหยาดเหงื่อทุกหยด!",
            "อย่าละสายตาจากเป้าหมายเด็ดขาด! จ้องมองมันแล้วพุ่งเข้าไปซะ!",
            "ความเหนื่อยล้ามันก็แค่ความรู้สึก แต่ความสำเร็จมันคือของจริง!",
            "ผมจะไม่ยอมล้มเด็ดขาด จนกว่าจะได้ยินเสียงระฆังหมดเวลา!",
            "ถ้าแขนขยับไม่ได้ ผมก็จะใช้ขา ถ้าขาขยับไม่ได้ ผมก็จะใช้ใจลุยเข้าไป!",
            "คู่ต่อสู้ที่แข็งแกร่งที่สุด ไม่ใช่งานตรงหน้า แต่คือใจที่ยอมแพ้ของผมเอง!",
            "ทุกสเต็ปที่ก้าว ทุกหมัดที่ออก มันจะสะสมเป็นพลังที่ยิ่งใหญ่!",
            "ถึงจะล้มกี่ครั้ง ผมก็จะลุกขึ้นมาด้วยความตั้งใจที่แน่วแน่กว่าเดิม!",
            "ผมจะเชื่อมั่นในหมัดของตัวเอง และเชื่อมั่นในวินัยที่ฝึกฝนมา!",
            "ไม่มีคำว่า 'ทำไม่ได้' มีแต่คำว่า 'ยังพยายามไม่พอ' เท่านั้น!",
            "ก้มหน้าหลบหมัดของความขี้เกียจ แล้วสวนกลับด้วยการลงมือทำทันที!",
            "สังเวียนชีวิตนี้ ผมจะเป็นแชมป์เปี้ยนให้ได้ด้วยสองมือนี้แหละ!",
            "ความเจ็บปวดจากการฝึกซ้อม มันเทียบไม่ได้กับความสุขตอนที่ทำสำเร็จหรอก!",
            "ผมจะไม่ถอยแม้แต่ก้าวเดียว พื้นที่ตรงนี้คือที่ที่ผมจะยืนหยัด!",
            "สูดหายใจลึกๆ รวบรวมสมาธิ แล้วบุกทะลวงมันไปเลย!",
            "งานยากก็เหมือนคู่ชกตัวใหญ่ ยิ่งมันตัวใหญ่ เวลาล้มมันก็ยิ่งดัง!",
            "ขอแค่มีความกล้าที่จะก้าวเดิน เส้นทางสู่แชมป์ก็เปิดออกแล้ว!"
        ]
    }
}
...
# ==========================================
# 2. OVERLAY นรก (PUNISHMENT & SLAP AWAKE ACTIVE)
# ==========================================
...
if st.session_state.get("slap_awake_active", False):
    ...
    if st.button("🔥 กูพร้อมกลับไปลุยแล้ว!"):
        if confirm_text.strip() == "กูจะไม่ยอมกลับไปเป็นขยะ":
            ...
            st.error("พิมพ์ให้ถูกทุกตัวอักษร! มึงยังไม่ตั้งใจพอ!")
    st.stop()

# ==========================================
# 3. ระบบล็อกอิน & แถบด้านข้าง (Eternal Echo)
# ==========================================
if "current_user" not in st.session_state: 
    st.session_state.current_user = None

with st.sidebar:
    st.title("⚙️ DISCIPLINE ARC V.100")
    ...
    if st.session_state.current_user is None:
        ...
        # 🔊 ETERNAL ECHO (เสียงกระชากสติตลอดเวลาใน Sidebar)
...
if st.session_state.current_user is None:
    st.title("⚙️ DISCIPLINE ARC: V.100 APEX PREDATOR")
...
# ==========================================
list_keys = ["missions", "study_missions", "backlog", "dark_room", "anti_simp", "dopamine_fails", "excuses", "cookie_jar", "deadlines", "haters", "iron_habits", "limit_breaks", "weakness_fuel", "notes", "sanctuary", "skill_forge"]
...
if overdue_count > 0:
    if active_mentor == "Gojo" and overdue_debt_accum > 100:
        overdue_debt_accum = 100
        st.toast("🤞 [ไร้ขีดจำกัด] โกโจกางอาณาเขต! บล็อกความเครียด หนี้เลือดจากงานค้างถูกจำกัดไว้ที่ 100!", icon="🛡️")
...
for h in db["iron_habits"][safe_email]:
    if isinstance(h, dict) and h.get("last_done_date") != today_str:
        raw_h.append({
            "id": h.get("id"), "ภารกิจ": h["name"], "user_order": h.get("user_order", 99), "battle_role": "Support", "is_boss": False, "ประเภท": "🟢 ชิลๆ", "is_habit": True,
            "รายละเอียด": h.get("รายละเอียด", ""), "consequence": h.get("consequence", "")
        })
...
if is_locked_in:
    ...
    if not all_active_tasks:
        st.success("🎉 ไม่มีงานค้างแล้ว! ปิดโหมด Locked In ได้เลย")
    else:
...
with colRight:
    ...
    # เพิ่มแท็บใหม่ "⚒️ โรงตีเหล็ก"
    tab_missions, tab_study, tab_forge, tab_habits, tab_sanctuary, tab_notes, tab_backlog, tab_cookie, tab_academic = st.tabs([
        "🔪 งาน", "📖 เรียน", "⚒️ โรงตีเหล็ก", "⛓️ วินัยเหล็ก", "🔥 พักใจ", "📓 โน้ตแผน", "📝 Backlog", "🍪 ชัยชนะ", "📚 ลานประลอง"
    ])
    ...
    with tab_missions:
        ...
        if todo_missions:
            for m in todo_missions:
                ...
                hype_color = "#4ba3ff" if active_mentor == "Jesus" else "#e2d141" if active_mentor == "Zenitsu" else "#ffa500"
                hype_bg = "rgba(75, 163, 255, 0.1)" if active_mentor == "Jesus" else "rgba(226, 209, 65, 0.1)" if active_mentor == "Zenitsu" else "rgba(255, 165, 0, 0.1)"
                    ...
                    for i, stask in enumerate(m["subtasks"]):
                        ...
                        if can_interact and checked != is_done:
                            ...
                            if checked and active_mentor == "Yuji":
                                ...
                                st.toast("🔥 บดขยี้ได้ 1 สเต็ป!", icon="⚙️")
                            save_db(db); safe_rerun()
                ...
                if active_mentor == "Subaru" and is_overdue:
                    if user.get("exp", 0) >= 10:
                        ...
                        c1.caption("⏪ สิทธิ์ Return by Death ต้องการ 10 EXP")
                        ...
                        for i, stask in enumerate(s["subtasks"]):
                            ...
                            if can_interact and checked != is_done:
                                ...
                                if checked and active_mentor == "Yuji":
                                    ...
                                    st.toast("🔥 เก็บเนื้อหาไป 1 บท!", icon="📖")
                                save_db(db); safe_rerun()
    ...
    # ----------------------------------------------------
    # ⚒️ TAB 3: โรงตีเหล็ก (THE SKILL FORGE) - NEW!
    # ----------------------------------------------------
    with tab_forge:
        ...
        for sk in active_skills:
            with st.container(border=True):
                ...
                if col2.button("🔥 ฝึกซ้อมวันนี้ (+10 EXP)", key=f"train_{sk['id']}", use_container_width=True):
                    sk["exp_gained"] = sk.get("exp_gained", 0) + 10
                    user["exp"] += 5  # ให้ EXP ตัวละครหลักด้วย
            ...
            with st.container(border=True):
                ...
                if col2.button("⚡ สวมใส่เพื่อฝึก (Equip)", key=f"equip_{sk['id']}", use_container_width=True):
                    if len(active_skills) >= 2:
                        st.error("🚨 กฎเหล็ก: มึงโฟกัสพร้อมกันได้แค่ 2 อย่าง! พักทักษะอื่นก่อนดึงอันนี้ไป!")
                    else:
                        sk["status"] = "active"; save_db(db); safe_rerun()
                        
                if col3.button("🗑️", key=f"del_sk_{sk['id']}"):
                    db["skill_forge"][safe_email].remove(sk); save_db(db); safe_rerun()
    ...
    for idx, c in enumerate(reversed(db["cookie_jar"].get(safe_email, []))):
        ...
        if isinstance(c, dict):
            ...
            if c2.button("🗑️", key=f"del_cj_{idx}_{c.get('id', idx)}"):
                db["cookie_jar"][safe_email].remove(c); save_db(db); safe_rerun()
        else: 
            c1.success(f"🏆 {c}")
