...
MENTORS = {
    "None": {
        ...
        "quotes": [
            ...
            "พักได้ แต่อย่ายยอมแพ้! เลียแผลเสร็จแล้วลุกขึ้นมาจับอาวุธซะ!",
            ...
            "เลิกบ่นแล้วก้มหน้าก้มตาทำซะ! โลกนี้ไม่มีที่ยืนให้คนอ่อนแอ",
            "ถ้ามึงไม่เริ่มทำวันนี้ วันพรุ่งนี้มึงก็ยังคงอยู่ที่เดิมเหมือนหมาข้างถนน",
            "ความฝันที่ยิ่งใหญ่ ไม่ได้สร้างด้วยการนอนฝันกลางวัน แต่มันสร้างด้วยหยาดเหงื่อ!",
            "ถ้าเหนื่อยก็หยุดพัก แต่ถ้ายังไม่ตายก็ลุกขึ้นมาสับต่อดิวะ!",
            "อย่าให้ใครมาดูถูกความพยายามของมึงได้ ด้วยการทำตัวขี้เกียจสันหลังยาว!",
            "ความสำเร็จไม่มีปาฏิหาริย์ มีแต่ความพยายามล้วนๆ!",
            "ทุกวินาทีที่มึงทิ้งขว้าง คืออนาคตที่มึงกำลังฆ่าตัวตายทางอ้อม!",
            "ลุกขึ้นมา! ไม่มีความสำเร็จไหนได้มาจากการนอนเกาพุงอยู่บนเตียง",
            "จงจำไว้ว่าความเจ็บปวดจากการฝึกซ้อม ดีกว่าความเจ็บปวดจากการเสียใจ",
            "มึงอยากเป็นผู้กำหนดชะตาชีวิตตัวเอง หรืออยากให้ความขี้เกียจมันเหยียบหัว?",
            "ไม่มีคำว่าสายเกินไปสำหรับการเริ่มต้นใหม่ แต่ถ้ามึงไม่เริ่มวันนี้ ชาตินี้ก็จบเห่!",
            "ความพยายามไม่เคยทรยศใคร ยกเว้นคนที่พยายามแบบขอไปที!",
            "ถ้ามึงกลัวความลำบาก มึงก็จงเตรียมตัวรับความฉิบหายในอนาคตได้เลย",
            "จงใช้ความโกรธและความแค้น เป็นแรงผลักดันให้มึงพุ่งไปข้างหน้า!",
            "ไม่มีใครช่วยมึงได้ นอกจากสองมือและสมองของมึงเอง ลุกขึ้นมาสู้!",
            "ถ้ามึงเลือกทางที่ง่าย ชีวิตมึงจะยาก แต่ถ้ามึงเลือกทางที่ยาก ชีวิตมึงจะสบาย!",
            "จำหน้าตัวเองตอนที่ไม่มีจะกินไว้ แล้วเอาความรู้สึกนั้นมาเผาผลาญความขี้เกียจซะ!",
            "จงก้าวข้ามขีดจำกัดของตัวเองทุกวัน วันละนิดก็ยังดี!",
            "อย่าเอาข้ออ้างมาเป็นเกราะกำบังความขี้เกียจของตัวเอง!",
            "ลุยให้สุดแรงเกิด แล้วปล่อยให้ผลลัพธ์มันพิสูจน์ว่ามึงคือของจริง!",
            "ชีวิตมันสั้นเกินกว่าจะมานั่งจมปลักอยู่กับความล้มเหลว ลุกขึ้นแล้วเดินต่อ!",
            "จงทำตัวให้มีค่า ให้สมกับที่เกิดมาเป็นมนุษย์คนหนึ่ง!",
            "ความกล้าหาญไม่ใช่การไม่กลัวอะไรเลย แต่คือการกลัวชิบหายแต่ก็ยังก้าวไปข้างหน้า!",
            "ถ้ามึงไม่สู้ในวันนี้ วันหน้ามึงก็ต้องก้มหัวให้คนอื่นเขาเหยียบย่ำ!",
            "จงจำไว้ว่าความสำเร็จเป็นของคนที่อดทนรอคอยและลงมือทำอย่างบ้าคลั่ง!",
            "ไม่มีทางลัดสู่ความสำเร็จ มีแต่ทางที่ต้องลุยผ่านคราบเหงื่อและหยาดน้ำตา!",
            "จงลบคำสบประมาทของพวกมัน ด้วยผลงานอันยอดเยี่ยมของมึง!",
            "ถ้ามึงล้มลง ก็จงลุกขึ้นมาใหม่ด้วยความดุดันกว่าเดิมร้อยเท่า!",
            "เลิกหาข้ออ้างเข้าข้างตัวเอง แล้วหันมาส่องกระจกดูความจริงซะ!",
            "ทุกการกระทำในวันนี้ กำลังบอกว่ามึงจะเป็นใครในอนาคต",
            "จงทำงานหนักในความเงียบ แล้วปล่อยให้ความสำเร็จมันกระแทกหน้าพวกมัน!",
            "ความสำเร็จไม่ได้หล่นมาจากฟ้า แต่มึงต้องปีนขึ้นไปคว้ามันด้วยมือตัวเอง!",
            "ถ้ามึงเหนื่อย ให้คิดถึงวันที่มึงต้องก้มหน้าขอเงินคนอื่นใช้!",
            "จงเป็นคนที่แข็งแกร่งจนไม่มีอะไรทำร้ายมึงได้อีกต่อไป!",
            "เลิกเป็นผู้เสพความบันเทิง แล้วมาเป็นผู้สร้างตำนานของตัวเองซะ!",
            "จงสู้ให้สุดใจขาดดิ้น ชัยชนะมันรอคนจริงอยู่ข้างหน้า!",
            "ไม่มีคำว่าสายสำหรับคนที่มีวินัยในหัวใจ!",
            "จงจำไว้ว่าความพยายามอยู่ที่ไหน ความสำเร็จอยู่ที่นั่นเสมอ!",
            "ลุกขึ้นมาจับอาวุธของมึง แล้วไปฟาดฟันอุปสรรคให้แหลกคามือ!",
            "ทางข้างหน้าอาจจะมืดมน แต่ถ้ามึงก้าวเดินต่อไป แสงสว่างมันจะมาเอง!"
        ]
    },
    "Jesus": {
        ...
        "quotes": [
            ...
            "สันติสุขของเราที่ให้กับเจ้านั้น ไม่เหมือนที่โลกให้ อย่าให้ใจของเจ้าวิตกและอย่ากลัวเลย",
            "ในโลกนี้เจ้าจะมีความทุกข์ยาก แต่จงชื่นใจเถิด เพราะเราได้ชนะโลกแล้ว",
            "จงเข้มแข็งและกล้าหาญเถิด อย่าหวาดหวั่นพรั่นพรึง เพราะพระเจ้าอยู่กับเจ้าทุกแห่งหน",
            "เรามาเพื่อเขาทั้งหลายจะได้ชีวิต และจะได้อย่างครบบริบูรณ์",
            "แม้เราจะเดินผ่านหุบเขาเงามัจจุราช เราก็ไม่กลัวอันตรายใดๆ เพราะพระองค์ทรงสถิตกับเรา",
            "พระองค์ทรงรักษาคนที่ชอกช้ำระกำใจ และทรงพันผูกบาดแผลของเขา",
            "อย่าวิตกกังวลถึงพรุ่งนี้ เพราะพรุ่งนี้ก็จะมีเรื่องวิตกกังวลของมันเอง",
            "จงขอแล้วจะได้ จงหาแล้วจะพบ จงเคาะแล้วจะเปิดให้แก่ท่าน",
            "พระองค์ทรงประทานกำลังแก่ผู้ที่อ่อนล้า และทรงเพิ่มเรี่ยวแรงแก่ผู้ที่ไม่มีกำลัง",
            "จงวางใจในพระยาห์เวห์ด้วยสุดใจของเจ้า และอย่าพึ่งพาความเข้าใจของตนเอง",
            "ความรักย่อมอดทนนานและมีใจนีรณี ความรักไม่อิจฉา ไม่โอ้อวด ไม่ยโส",
            "พระเจ้าทรงเป็นที่ลี้ภัยและเป็นกำลังของเรา เป็นความช่วยเหลือที่พร้อมอยู่ในยามยากลำบาก",
            "จิตวิญญาณของเราสงบอยู่แต่ในพระเจ้า ผู้ทรงเป็นความรอดของเรา",
            "จงให้ความสว่างของท่านส่องแสงออกไปต่อหน้ามนุษย์ เพื่อว่าเขาจะได้เห็นความดีของท่าน",
            "พระองค์ทรงเสริมกำลังให้เราทุกสิ่งผ่านทางพระองค์ผู้ทรงเสริมกำลังเรา",
            "ความทุกข์ยากก่อให้เกิดความอดทน และความอดทนก่อให้เกิดความพิสูจน์ได้",
            "พระองค์ทรงนับเส้นผมทุกเส้นบนศีรษะของท่านไว้หมดแล้ว ดังนั้นอย่ากลัวเลย",
            "จงชื่นชมยินดีในความหวัง จงอดทนต่อความยากลำบาก และจงอธิษฐานอยู่อย่างสม่ำเสมอ",
            "พระเจ้าไม่ได้ประทานจิตแห่งความขลาดกลัวแก่เรา แต่ประทานจิตแห่งฤทธานุภาพ ความรัก และการสติสัมปชัญญะ",
            "จงมอบภาระของท่านไว้กับพระยาห์เวห์ และพระองค์จะทรงค้ำจุนท่าน",
            "สติปัญญาเริ่มต้นด้วยความยำเกรงพระยาห์เวห์ และความรู้เรื่ององค์บริสุทธิ์คือความเข้าใจ",
            "พระองค์ทรงกระทำให้ทุกสิ่งงดงามตามฤดูกาลของมัน",
            "จิตใจที่ร่าเริงเป็นยาอย่างดี แต่จิตใจที่ชอกช้ำทำให้กระดูกแห้งเหี่ยว",
            "จงรักเพื่อนบ้านเหมือนรักตนเอง นี่คือบัญญัติที่ยิ่งใหญ่ที่สุด",
            "ผู้ใดสัตย์ซื่อในของเล็กน้อย ก็จะสัตย์ซื่อในของมากๆ ด้วยเช่นกัน",
            "พระองค์ทรงเรียกชื่อเจ้า เจ้าเป็นของเรา เจ้ามีค่าและเป็นที่รักยิ่งในสายพระเนตรของเรา",
            "จงแสวงหาแผ่นดินของพระเจ้าและความชอบธรรมของพระองค์ก่อน แล้วพระองค์จะทรงเพิ่มเติมนิ่งสิ่งเหล่านี้ให้",
            "พระองค์ทรงปูพระกระยาหารต่อหน้าเราต่อหน้าศัตรูของเรา",
            "ความจริงจะทำให้ท่านเป็นไท",
            "พระองค์ทรงเป็นทางนั้น เป็นความจริง และเป็นชีวิต",
            "ผู้ใดถ่อมตัวลงผู้นั้นจะได้รับการยกย่องขึ้น",
            "พระองค์ทรงโปรดปรานผู้มีใจถ่อมและผู้ที่มีใจชอกช้ำ",
            "จงให้อภัยแก่กันและกัน เหมือนอย่างที่พระเจ้าทรงให้อภัยแก่ท่าน",
            "สันติสุขที่เรามอบให้ท่าน ไม่ใช่สันติสุขแบบที่โลกให้",
            "พระองค์ทรงเป็นผู้สร้างเราขึ้นมาในครรภ์มารดา เราถูกสร้างมาอย่างวิจิตรพิสดาร",
            "จงวางใจในพระองค์ด้วยสิ้นสุดใจ และพระองค์จะทรงกระทำให้วิถีของท่านราบรื่น",
            "พระองค์ทรงสถิตใกล้ผู้ที่มีใจแตกสลาย และทรงช่วยผู้ที่มีจิตใจสำนึกผิด",
            "ความหวังในพระเจ้าจะไม่ทำให้เราต้องผิดหวัง",
            "พระองค์ทรงประทานสันติสุขอันเกินความเข้าใจแก่ผู้ที่เชื่อวางใจ",
            "จงเข้มแข็งเถิด และให้จิตใจของท่านกล้าหาญขึ้นเถิด ท่านทั้งหลายผู้มีความหวังใจในพระยาห์เวห์",
            "พระองค์ทรงเป็นผู้พิทักษ์รักษาชีวิตของท่านจากอันตรายทั้งสิ้น",
            "พระองค์ทรงนำเราไปริมน้ำแดนสงบ และทรงฟื้นฟูจิตวิญญาณของเรา",
            "พระองค์ทรงฟังเสียงร้องทูลของเราเมื่อเราเรียกหาพระองค์",
            "ความรักมั่นคงของพระยาห์เวห์ไม่มีวันหมดสิ้น และความเมตตาของพระองค์ไม่มีวันสิ้นสุด",
            "พระองค์ทรงเปลี่ยนความโศกเศร้าของเราให้เป็นการเต้นรำ",
            "จงให้พระองค์เป็นที่ปีติยินดีของท่าน และพระองค์จะประทานตามใจปรารถนาของท่าน",
            "พระเจ้าทรงสถิตกับท่านเสมอ ไม่ว่าท่านจะเดินไปที่ใด",
            "จงก้าวเดินต่อไปด้วยความศรัทธา เพราะพระองค์ทรงนำทางท่านอยู่ทุกย่างก้าว"
        ]
    },
    "Zenitsu": {
        ...
        "quotes": [
            "คำขอโทษน่ะ... ไม่ต้องหรอก มันไม่มีประโยชน์แล้ว",
            "ฉันไม่ได้มาที่นี่เพื่อคุยเล่น ฉันมาเพื่อจบเรื่องนี้",
            "ปู่ครับ... ดูผมให้ดีนะ ผมจะทำมันให้สำเร็จ",
            "เวลาของความลังเลมันหมดลงไปตั้งนานแล้ว",
            "ไม่ต้องพูดอะไรทั้งนั้น แค่ทำในสิ่งที่ต้องทำก็พอ",
            "หน้าที่ของฉัน คือกวาดล้างอุปสรรคตรงหน้าให้สิ้นซาก",
            "ถ้าทำไม่ได้ก็แค่ตาย... แต่วันนี้ฉันจะไม่ตาย",
            "ความรู้สึกหรอ? ฉันโยนมันทิ้งไปหมดแล้ว ตอนนี้มีแค่เป้าหมาย",
            "จะเหนื่อย จะเจ็บแค่ไหน ร่างกายนี้ก็ต้องขยับตามคำสั่ง",
            "ฉันจะชดใช้ทุกอย่างด้วยผลลัพธ์ ไม่ใช่ด้วยน้ำตา",
            "ประกายสายฟ้าฟาดฟันความขี้เกียจให้มลายหายไปในพริบตา!",
            "ถึงจะกลัวจนตัวสั่น แต่ถ้าไม่ทำตอนนี้แล้วเมื่อไหร่ล่ะวะ!",
            "ความมืดมิดในจิตใจ จะถูกตัดขาดด้วยกระบวนท่าที่เร็วที่สุด!",
            "ฉันรวบรวมสมาธิทั้งหมดที่มี เพื่อก้าวข้ามขีดจำกัดในวินาทีนี้!",
            "จงตื่นขึ้นมา! อย่าปล่อยให้ความอ่อนแอครอบงำจิตวิญญาณ!",
            "เสียงฟ้าร้องคำรามเรียกให้ฉันลุกขึ้นมาสู้กับโชคชะตา!",
            "ไม่มีเวลามานั่งร้องไห้ฟูมฟายแล้ว ลุยเข้าไปเลย!",
            "นี่คือการเดิมพันด้วยชีวิตและความมุ่งมั่นทั้งหมดของฉัน!",
            "ฉันจะไม่ยอมถอยหลังให้ใครหน้าไหนอีกแล้วในชาตินี้!",
            "สายฟ้าแลบผ่านความมืด ส่องทางให้ฉันเห็นเป้าหมายชัดเจน!",
            "จงรวบรวมลมหายใจแล้วพุ่งทะยานไปข้างหน้าแบบสุดกำลัง!",
            "ความหวาดกลัวถูกเผาผลาญจนหมดสิ้น เหลือเพียงสัญชาตญาณแห่งนักรบ!",
            "ฉันจะจัดการงานนี้ให้จบภายในดาบเดียว!",
            "อย่าดูถูกคนที่มีแผลเต็มตัว เพราะนั่นคือร่องรอยของผู้รอดชีวิต!",
            "พลังที่แท้จริงจะระเบิดออกมา เมื่อเราไม่มีทางเลือกอื่นนอกจากต้องชนะ!",
            "เตรียมรับมือกับความเร็วที่เหนือกว่าเสียงของฉันได้เลย!",
            "ทุกย่างก้าวที่พุ่งไป คือการประกาศสงครามกับความขี้เกียจ!",
            "ฉันฉีกกระชากข้ออ้างทิ้งทั้งหมด แล้วพุ่งเข้าหาเป้าหมายอย่างไร้ความปรานี!",
            "ตื่นจากความฝันอันหวาดกลัว แล้วลุกขึ้นมาสร้างปาฏิหาริย์ด้วยตัวเอง!",
            "ดาบเล่มนี้ถูกชักออกมาเพื่อตัดวงจรอุบาทว์ของความล้มเหลว!",
            "ความตั้งใจจริงจะส่องประกายสว่างยิ่งกว่าสายฟ้ากลางพายุ!",
            "ฉันจะไม่ยอมให้ความอ่อนแอมาขโมยความสำเร็จไปจากมือฉันเด็ดขาด!",
            "พุ่งทะยานออกไปด้วยความเร็วแสง แล้วบดขยี้อุปสรรคให้ราบคาบ!",
            "นี่ไม่ใช่เวลามากลัว แต่เป็นเวลาที่ต้องแสดงให้เห็นว่าเราเจ๋งแค่ไหน!",
            "จิตใจที่แน่วแน่และรวดเร็ว คืออาวุธที่ทรงพลังที่สุดของนักรบ!",
            "ฉันก้าวข้ามความหวาดกลัวด้วยความเด็ดเดี่ยวขั้นA!",
            "สายฟ้าแห่งการตื่นรู้ได้ผ่าลงกลางใจของฉันแล้ว ลุย!",
            "จงรวบรวมพลังเฮือกสุดท้าย แล้วพุ่งชนเป้าหมายให้พังทลาย!",
            "ไม่มีคำว่าปรานีให้กับความขี้เกียจในตัวตนของฉันอีกต่อไป!",
            "ความเร็วและความเด็ดขาด จะพาฉันไปสู่ชัยชนะที่ยิ่งใหญ่!",
            "เตรียมตัวรับแรงกระแทกจากความมุ่งมั่นที่ระเบิดออกมาซะ!",
            "ฉันคือนักล่าผู้รวดเร็วดั่งสายฟ้า งานนี้ไม่มีทางรอดมือฉันแน่!",
            "ทุกวินาทีมีค่าดั่งทองคำ พุ่งเข้าไปจัดการมันเดี๋ยวนี้!",
            "พลังจิตอันฮึกเหิมผลักดันให้ฉันทะลวงผ่านทุกกำแพงที่ขวางกั้น!",
            "ฉันจะทำให้ความกลัวต้องสยบแทบเท้าด้วยความกล้าหาญของฉัน!",
            "สายฟ้าฟาดฟันอุปสรรคจนไม่เหลือซาก สะใจโว้ย!",
            "จงวิ่งไปข้างหน้าอย่าหยุดหย่อน จนกว่าจะถึงเส้นชัย!",
            "ความพยายามที่รวดเร็วและแม่นยำ คือกุญแจสู่ความสำเร็จของแท้!",
            "ฉันพร้อมแล้วที่จะปล่อยกระบวนท่าพิฆาตความขี้เกียจให้สิ้นซาก!",
            "ลุกขึ้นมา! จงเป็นสายฟ้าที่แผดเผาความล้มเหลวให้เป็นจุล!"
        ]
    },
    "Yuji": {
        ...
        "quotes": [
            ...
            "หมัดแห่งความมุ่งมั่นพร้อมซัดความขี้เกียจให้กระเด็น!",
            "ถึงร่างกายจะล้า แต่ใจยังสู้โว้ย ลุยต่อไม่รอแล้วนะ!",
            "ก้าวทีละก้าว สะสมชัยชนะเล็กๆ ให้กลายเป็นความสำเร็จชิ้นใหญ่!",
            "ไม่ว่าศัตรูจะหน้าไหน หรือภารกิจจะยากแค่ไหน กูซัดแหลกแน่!",
            "การกระทำสำคัญกว่าคำพูด ลงมือทำมันซะตอนนี้!",
            "ความอดทนคือพลังที่แท้จริงของผู้ชายคนนี้!",
            "กูเกิดมาเพื่อชนะ ไม่ได้เกิดมาเพื่อเป็นภาระให้ใครมาสมเพช!",
            "ไม่ถอย ไม่หนี มีแต่ลุยหน้าลูกเดียว!",
            "พลังใจที่แข็งแกร่งกว่าเหล็กกล้า ขับเคลื่อนชีวิตให้เดินหน้าต่อไป!",
            "ลุกขึ้นมาสู้สิวะไอ้น้อง! ชีวิตนี้ไม่มีคำว่ายอมแพ้ในพจนานุกรมของกู!",
            "ทุกๆ งานที่ทำสำเร็จ คือการอัปเกรดตัวเองให้เก่งขึ้นอีกขั้น!",
            "จงภูมิใจในหยาดเหงื่อที่เสียไป เพราะมันคือน้ำหล่อเลี้ยงความสำเร็จ!",
            "ไม่ว่าจะเจอปัญหาเหี้ยอะไร กูจะใช้หมัดกระแทกมันให้พังเป็นเสี่ยงๆ!",
            "จงเป็นฟันเฟืองที่แข็งแกร่งที่สุดในกลไกชีวิตของตัวเอง!",
            "ความเหนื่อยล้าเป็นเพียงอารมณ์ชั่วคราว แต่ความสำเร็จอยู่ค้ำฟ้า!",
            "ลุยเข้าไป! อย่าปล่อยให้เวลาไหลผ่านไปโดยไม่ได้ทำอะไรเลย!",
            "ความตั้งใจจริงเอาชนะได้ทุกอุปสรรค เชื่อมั่นในตัวเองเข้าไว้!",
            "กูจะก้าวผ่านวันนี้ไปให้ได้ด้วยความภาคภูมิใจ!",
            "พลังแห่งความฮึกเหิมลุกโชนอยู่ในอก ตบเกียร์เดินหน้าเต็มกำลัง!",
            "ไม่มีคำว่าเป็นไปไม่ได้ สำหรับคนที่ไม่เคยหยุดพยายาม!",
            "ซัดความขี้เกียจให้คว่ำคามือ แล้วไปหยิบเอาความสำเร็จมาครอง!",
            "จงจำไว้ว่าเราคือนายของโชคชะตา ไม่ใช่ทาสของความเกียจคร้าน!",
            "ไม่ว่าทางจะไกลแค่ไหน ถ้าก๋ากั่นเดินหน้า เดี๋ยวก็ถึงเอง!",
            "พลังใจเกินร้อย พร้อมลุยงานตรงหน้าให้จบสิ้นในวันนี้!",
            "ลุกขึ้นมาขยับร่างกายแล้วลุยงานซะ! เลิกนอนอืดเป็นจระเข้สวนสัตว์ได้แล้ว!",
            "จิตวิญญาณนักสู้ในตัวกู มันกำลังร้องคำรามให้ออกไปลุย!",
            "ทุกย่างก้าวที่มั่นคง คือรากฐานของอนาคตที่ยิ่งใหญ่!",
            "อย่าให้ความกลัวมามีอำนาจเหนือจิตใจ ลุยเข้าไปจัดการมัน!",
            "กูพร้อมชนทุกปัญหาแบบตาต่อตา ฟันต่อฟัน!",
            "ความสำเร็จไม่ได้มาเพราะโชคช่วย แต่มันมาเพราะความซาดิสต์ในการทำงาน!",
            "ลุยให้สุดเหวี่ยง แล้วไปฉลองความสำเร็จกันตอนค่ำ!",
            "ฟันเฟืองทุกตัวต้องหมุนวน กูจะไม่ยอมเป็นจุดอ่อนในระบบเด็ดขาด!",
            "ความพยายามอย่างไม่ลดละ จะสร้างปาฏิหาริย์ให้เห็นกับตา!",
            "อุปสรรคมีไว้ให้ข้าม ไม่ได้มีไว้ให้กราบกราน ซัดมันให้ร่วง!",
            "หัวใจที่กล้าแกร่งและไม่ยอมแพ้ คือเกราะป้องกันที่ดีที่สุด!",
            "ลุกขึ้นมาสู้ต่อไอ้สหาย เส้นทางข้างหน้ารอให้เราไปพิชิตอยู่!",
            "พลังแห่งการลงมือทำจะเปลี่ยนชีวิตมึงจากหน้ามือเป็นหลังมือ!",
            "ไม่มีคำว่าพ่ายแพ้ในพจนานุกรมของคนจริง ลุย!",
            "กำหมัดให้แน่นแล้วพุ่งชนเป้าหมายให้แหลกคามือ!",
            "กูจะสู้จนกว่าแรงเฮือกสุดท้ายจะหมดไปจากร่าง!"
        ]
    },
    "Gojo": {
        ...
        "quotes": [
            ...
            "ท้าทายอำนาจมืดของความขี้เกียจ ด้วยรอยยิ้มอันทรงเสน่ห์ของฉันซะ!",
            "ไม่มีอะไรที่คนไร้ขีดจำกัดอย่างฉันทำไม่ได้หรอกนะจะบอกให้!",
            "จัดการงานพวกนี้เสร็จไวๆ แล้วไปพักผ่อนแบบหล่อๆ กันดีกว่า",
            "ความฉลาดและไหวพริบ จะนำพาเราผ่านพ้นทุกอุปสรรคไปได้อย่างชิลๆ",
            "มองโลกในแง่ดี แล้วทุกอย่างจะง่ายดายราวกับปอกกล้วยเข้าปาก",
            "พลังงานล้นเหลือและความมั่นใจระดับ S-Class พร้อมทำงานแล้ว!",
            "ความกดดันหรอ? ส่งมาเลย เดี๋ยวฉันจัดการดีดมันทิ้งในทีเดียว",
            "ทุกอย่างอยู่ภายใต้การควบคุมของฉันหมดแล้ว สบายใจได้!",
            "ความเท่และความเก่งกาจ มันคุมกำเนิดความล้มเหลวได้หมดแหละ",
            "มาเถอะงานยาก แค่กระดิกนิ้วเดียวก็พังพินาศเป็นจุลแล้ว!",
            "ความมั่นหน้ามันจะพาเราไปสู่ความสำเร็จเอง เชื่อฉันสิ!",
            "เก่งเกินไปก็น่าเบื่อนะ แต่พอมีงานท้าทายเข้ามา มันก็สนุกดีเหมือนกัน",
            "จงเชื่อมั่นในความอัจฉริยะของตัวเอง แล้วลุยงานให้เต็มที่!",
            "การเคลียร์งานแบบหล่อๆ คือสไตล์ของคนเหนือคน!",
            "ไม่มีอุปสรรคไหนผ่านพ้นอาณาเขตอินฟินิตี้ของฉันไปได้หรอ",
            "ฉีกยิ้มกว้างๆ แล้วไปตบหน้าความขี้เกียจให้หน้าสั่นกันเถอะ",
            "ความสามารถระดับท็อปฟอร์ม ทำอะไรก็สำเร็จอย่างไร้ที่ติ",
            "ผ่อนคลายแต่จริงจัง นั่นแหละคือเคล็ดลับความสำเร็จของฉัน",
            "งานแค่นี้จิ๊บๆ น่า อย่าไปกลัว ลุยเลย!",
            "ความเป็นเลิศมันอยู่ในสายเลือดของฉันอยู่แล้ว ชิลๆ",
            "จัดการมันแบบม้วนเดียวจบ แล้วไปใช้ชีวิตให้มีความสุขกันเถอะ",
            "ความเก่งกาจที่แท้จริง คือการทำเรื่องยากให้กลายเป็นเรื่องหมูๆ",
            "ไม่มีใครเทียบชั้นความเร็วและความสามารถของเราได้หรอก",
            "ความมั่นใจคือเครื่องสำอางที่ดีที่สุดของผู้ชนะ!",
            "เปิดโหมดอัจฉริยะแล้วกวาดล้างงานกองโตให้เกลี้ยงในพริบตา",
            "ทุกย่างก้าวเต็มไปด้วยความสง่างามและชัยชนะอันงดงาม",
            "ความขี้เกียจเรอะ? เจอกับพลังอินฟินิตี้ของฉันหน่อยเป็นไง!",
            "เหนือชั้นกว่าใครเพื่อน ก็คือพวกเรานี่แหละ ลุย!",
            "จัดการทุกปัญหาด้วยความเหนือชั้นอย่างไร้ที่ติ",
            "รอยยิ้มของผู้ชนะถูกประดับอยู่บนใบหน้าของฉันเสมอ",
            "ความสำเร็จระดับมาสเตอร์พีซ กำลังรอให้ฉันไปหยิบมาครอบครอง",
            "ชิลๆ สบายๆ แต่ผลงานออกมาโคตรปัง นั่นแหละสไตล์โกโจ!",
            "ปราบงานยากให้กลายเป็นเรื่องตลกขบขันกันเถอะ",
            "ความสามารถล้นเหลือจนล้นปรี่ เอาไปใช้จัดการงานตรงหน้าซะ!",
            "ไม่มีความกดดันใดๆ ทั้งสิ้น เพราะฉันคือนัมเบอร์วัน!",
            "สะบัดมือทีเดียว งานกองเป็นภูเขาก็ราบเป็นหน้ากลอง",
            "ความเท่และความเก่งมาบรรจบกันอย่างลงตัวในงานนี้",
            "ลุยสิครับรออะไรอยู่ ชัยชนะมันนอนรอเราอยู่โน่นแล้ว!",
            "ไม่ว่าปัญหาจะซับซ้อนแค่ไหน ฉันก็แก้ได้ในพริบตาเดียว!",
            "อาณาเขตแห่งชัยชนะกางออกแล้ว ทุกคนเตรียมตัวรับความปังได้เลย!"
        ]
    },
    "Toji": {
        ...
        "quotes": [
            ...
            "สัญชาตญาณนักล่าบอกกูว่า งานนี้ต้องสำเร็จเท่านั้น ห้ามพลาด!",
            "ความรุนแรงและความเด็ดขาด คือภาษาเดียวที่โลกใบนี้เข้าใจ!",
            "ลุกขึ้นมาล่าความสำเร็จซะ อย่าให้มันล่ามึงได้!",
            "กูไม่สนวิธีการ กูสนแค่ว่างานเสร็จและกูได้สิ่งที่ต้องการรึเปล่า!",
            "ความแข็งแกร่งไม่ได้มาจากพรสวรรค์ แต่มันมาจากการขัดเกลาผ่านความเจ็บปวด",
            "ถ้ามึงไม่อยากตายอย่างอนาถ ก็จงวิ่งไปข้างหน้าและคว้าชัยชนะมาซะ!",
            "โลกนี้มันโหดร้าย ถ้ามึงไม่แกร่งพอก็เตรียมตัวโดนกลืนกินได้เลย",
            "กูพร้อมแลกทุกอย่างเพื่อให้ได้มาซึ่งเป้าหมายที่ยิ่งใหญ่",
            "จัดการเป้าหมายให้เด็ดขาด อย่าให้มันมีโอกาสได้แก้ตัว!",
            "ความดิบเถื่อนและดุดัน คือเครื่องหมายการค้าของนักสู้ตัวจริง",
            "ไม่มีคำว่าปรานีให้กับความอ่อนแอในตัวมึง ลุกขึ้นมาสับมัน!",
            "อาวุธพร้อม จิตใจพร้อม ลุยเข้าไปฆ่าฟันอุปสรรคให้หมดสิ้น!",
            "กูเหยียบย่ำทุกคำดูถูก แล้วแปลงมันเป็นพลังขับเคลื่อนชีวิต",
            "ความสำเร็จเป็นของคนที่กล้าได้กล้าเสีย ไม่ใช่พวกขี้ขลาดตาขาว",
            "กระชากเป้าหมายลงมาขยี้คาเท้าซะ ให้มันรู้ซึ้งถึงพลังของพวกเรา!",
            "ความหิวกระหายในชัยชนะ จะทำให้มึงไม่มีวันยอมแพ้",
            "ลุยงานนี้ให้เหมือนกับว่ามันเป็นโอกาสสุดท้ายในชีวิตของมึง!",
            "กูไม่เคยกลัวความยากลำบาก เพราะกูคือผู้สร้างความยิ่งใหญ่ด้วยตัวเอง",
            "ความเด็ดเดี่ยวและไร้ความปรานี คือกุญแจสู่การเป็นผู้ชนะ",
            "ฝ่าฟันดงปัญหาด้วยความดุดันดั่งสัตว์ป่าล่าเหยื่อ",
            "ไม่มีใครหยุดกูได้ ถ้ากูตั้งใจจะทำอะไรแล้ว มันต้องสำเร็จเท่านั้น!",
            "ล่าเป้าหมายให้เจอ แล้วเด็ดหัวมันมาบูชาความสำเร็จซะ!",
            "ความโหดร้ายของโลกนี้ เทียบไม่ได้เลยกับความมุ่งมั่นของกู",
            "ลุกขึ้นมาทำเงินและสร้างชื่อเสียงให้สมกับที่เป็นนักรบสัญญาสวรรค์!",
            "กูไม่สนหน้าอินทร์หน้าพรหมที่ไหน ใครขวางทางกูฆ่าเรียบ!",
            "ความสำเร็จที่ได้มาด้วยความยากลำบาก มันหอมหวานที่สุดเว้ย",
            "ใช้สัญชาตญาณดิบเถื่อนนำทาง แล้วพุ่งชนความสำเร็จแบบไม่ยั้ง!",
            "ไม่มีคำว่าข้อแก้ตัวสำหรับคนระดับกู ลงมือทำเดี๋ยวนี้!",
            "บดขยี้อุปสรรคทุกชิ้นให้แหลกคามือแบบไม่ให้เหลือซาก",
            "ความทะเยอทะยานจะพาเราไปยืนอยู่บนจุดสูงสุดของห่วงโซ่อาหาร",
            "ลุยงานบอสตัวนี้ให้เละ แล้วรับรางวัลมหาศาลเข้ากระเป๋าซะ!",
            "ความจริงอันโหดร้ายสอนให้กูต้องแข็งแกร่งและเด็ดขาดกว่าเดิม",
            "พุ่งชนปัญหาด้วยความเร็วและความแรงระดับพายุเฮอร์ริเคน",
            "กูคือผู้ล่าที่น่ากลัวที่สุดสำหรับความขี้เกียจในตัวมึง",
            "ฟันฝ่าดงความชิบหายด้วยความมั่นใจและเลือดนักสู้",
            "จงจำไว้ว่าชัยชนะเป็นของคนที่กล้าหาญและบ้าระห่ำพอ!",
            "จัดการมันให้จบในหมัดเดียว แบบไม่ต้องมีพิธีรีตองอะไรมาก!",
            "ความกระหายในชัยชนะ จะไม่มีวันมอดดับลงในหัวใจของกู",
            "ลุกขึ้นมา! ไปคว้าชัยชนะอันยิ่งใหญ่มาเป็นของมึงซะ!"
        ]
    },
    "Subaru": {
        ...
        "quotes": [
            ...
            "วนกลับมาแก้มือใหม่กี่รอบก็ได้ ขอแค่อย่าถอดใจยอมแพ้กลางทาง!",
            "ความตายและความพ่ายแพ้สอนให้ฉันเติบโตและแกร่งขึ้นกว่าเดิม",
            "ฉันจะปกป้องอนาคตของตัวเองด้วยความพยายามสุดชีวิต!",
            "ไม่ว่าจะเจ็บปวดแค่ไหน ฉันก็จะก้าวเดินต่อไปข้างหน้า!",
            "หัวใจที่แตกสลาย ถูกประกอบขึ้นใหม่ด้วยความตั้งใจอันแน่วแน่",
            "ฉันจะไม่ยอมให้ความพ่ายแพ้ในอดีต มากำหนดอนาคตของฉันเด็ดขาด",
            "ลุกขึ้นมา! แม้จะต้องตายแล้วเกิดใหม่กี่ครั้ง ฉันก็สู้ไม่ถอย!",
            "ความมุ่งมั่นและพลังใจ คือสิ่งเดียวที่ช่วยฉันไว้ในยามวิกฤต",
            "ฉันจะพลิกสถานการณ์จากนรกให้กลายเป็นสวรรค์ด้วยมือคู่นี้!",
            "ทุกความเจ็บปวดคือบทเรียนราคาแพง ที่จะไม่ยอมให้เสียเปล่า",
            "กัดฟันกรอดแล้วพุ่งชนปัญหา แม้ขาจะสั่นด้วยความกลัวก็ตาม",
            "ฉันไม่ใช่คนเก่ง แต่ฉันเป็นคนที่ไม่เคยยอมจำนนต่อโชคชะตา",
            "ลุกขึ้นมาแก้ตัวใหม่ วันนี้แหละคือวันที่เราจะชนะ!",
            "ความพยายามนับครั้งไม่ถ้วน จะต้องให้ผลลัพธ์ที่งดงามในสักวัน",
            "ฉันจะลบความอัปยศในอดีต ด้วยชัยชนะอันยิ่งใหญ่ในวันนี้",
            "ไม่ว่าใครจะดูถูกฉันยังไง ฉันจะพิสูจน์ให้เห็นว่าฉันทำได้!",
            "ความพยายามอยู่ที่ไหน การเริ่มต้นใหม่ก็อยู่ที่นั่นเสมอ",
            "จงลุกขึ้นมาจากกองเพลิงแห่งความล้มเหลว แล้วแผดเผาอุปสรรคให้หมดสิ้น",
            "ฉันจะเขียนตอนจบของเรื่องนี้ใหม่ด้วยความพยายามของฉันเอง",
            "แม้หนทางจะเต็มไปด้วยหนามยอกอก ฉันก็จะเดินหน้าต่อไป",
            "ความอดทนและความดื้อรั้น คือเวทมนตร์วิเศษของฉัน",
            "ลุกขึ้นมาสู้กับความจริงอันโหดร้าย แล้วเอาชนะมันให้ได้!",
            "ฉันจะไม่ยอมร้องไห้ด้วยความเสียใจ แต่จะร้องไห้ด้วยความยินดีในชัยชนะ",
            "ความพ่ายแพ้เป็นเพียงจุดเริ่มต้นของการแก้เกมที่ยิ่งใหญ่",
            "สู้อีกนิดเดียวเท่านั้น ประตูแห่งความสำเร็จก็เปิดรออยู่แล้ว",
            "จิตใจที่สู้ไม่ถอย จะนำพาเราไปสู่ปาฏิหาริย์ที่แท้จริง",
            "ฉันจะใช้ทุกโอกาสที่มี แก้ไขความผิดพลาดให้ถูกต้องทั้งหมด",
            "ลุกขึ้นมาไอ้ตัวฉัน! เรายังมีลมหายใจ เรายังสู้ต่อได้!",
            "ความหวังริบหรี่แค่ไหน ก็จะจุดประกายมันขึ้นมาใหม่ให้สว่างไสว",
            "ฉันยอมเจ็บตัวและเหนื่อยล้า ดีกว่าต้องมานั่งเสียใจทีหลัง",
            "ก้าวข้ามขีดจำกัดของความอ่อนแอ แล้วกลายเป็นคนใหม่ที่แข็งแกร่งกว่าเดิม",
            "ไม่มีคำว่าเป็นไปไม่ได้ สำหรับคนที่มีโอกาสได้เริ่มต้นใหม่อีกครั้ง",
            "ฉันจะสู้จนกว่าวินาทีสุดท้ายของชีวิตจะมาถึง",
            "ความทรงจำอันเจ็บปวด คือเครื่องเตือนใจให้ฉันไม่กลับไปกากอีก",
            "ลุกขึ้นมาสู้สิวะ! อย่าปล่อยให้ความพ่ายแพ้มาหัวเราะเยาะเราได้",
            "ฉันจะทวงคืนทุกอย่างที่ควรจะเป็นของฉันด้วยสองมือนี้",
            "ความมุ่งมั่นที่จะเปลี่ยนตัวเอง มันยิ่งใหญ่กว่าอุปสรรคใดๆ ในโลก",
            "ไม่ยอมแพ้เด็ดขาด! หนทางข้างหน้ารอให้เราไปคว้าชัยชนะอยู่",
            "ลุกขึ้นมาเริ่มใหม่จากศูนย์ แล้วทะยานไปสู่จุดสูงสุดให้ได้!",
            "ฉันจะสู้จนกว่าโลกใบนี้จะต้องจดจำชื่อของฉัน!"
        ]
    },
    "Ippo": {
        ...
        "quotes": [
            ...
            "หมัดฮุกซ้าย หมัดฮุกขวา เดมป์ซีย์โรลถล่มความขี้เกียจให้ราบคาบ!",
            "การฝึกซ้อมอย่างหนักหน่วงจะไม่เคยทรยศใคร เชื่อมั่นในตัวเองเข้าไว้!",
            "ก้าวขาออกไปข้างหน้า แล้วต่อยปัญหาให้กระเด็นตกเวทีไปเลย!",
            "ผมอยากรู้เหลือเกินว่า ความแข็งแกร่งที่แท้จริงมันหน้าตาเป็นยังไง",
            "ทุกหยาดเหงื่อที่เสียไปในห้องซ้อม จะออกดอกออกผลบนสังเวียนจริง",
            "ไม่ว่าจะโดนซัดร่วงกี่ครั้ง ผมก็จะลุกขึ้นมาสู้ใหม่ด้วยรอยยิ้มเสมอ",
            "หัวใจที่มุ่งมั่นและสุภาพ คืออาวุธลับของนักสู้ผู้ไม่ยอมแพ้",
            "ซ้อมให้หนัก ชกให้เต็มที่ แล้วควชัยชนะมาครองให้ได้!",
            "ผมจะก้าวข้ามขีดจำกัดของตัวเองในทุกๆ วันที่ยังมีลมหายใจ",
            "ความพยายามและการซ้อมอย่างสม่ำเสมอ คือคำตอบของทุกสิ่ง",
            "ไม่ถอยหลังเด็ดขาด! สังเวียนชีวิตนี้มีแต่ต้องเดินหน้าลุยลูกเดียว",
            "หมัดแห่งความมุ่งมั่นพุ่งทะยานเข้าเป้าหมายอย่างแม่นยำและทรงพลัง",
            "ความเจ็บปวดจากการฝึกซ้อม คือเครื่องหมายว่าเรากำลังเก่งขึ้น",
            "ผมจะต่อยความขี้เกียจให้กระเด็นออกไปจากชีวิตผมให้หมด!",
            "ก้าวเท้าเข้าวงใน แล้วกระหน่ำหมัดใส่เป้าหมายไม่ยั้งมือ!",
            "ความฝันที่จะเป็นผู้ชนะอยู่ไม่ไกลเกินเอื้อม แค่ต้องก้าวไปให้ถึง",
            "ลุกขึ้นมาซ้อม ลุกขึ้นมาสู้ เพื่ออนาคตที่เราวาดฝันไว้!",
            "หัวใจนักสู้ในตัวผมมันกำลังพองโต พร้อมที่จะระเบิดพลังออกมาแล้ว",
            "ไม่มีคำว่าทางลัดสำหรับแชมป์เปี้ยน มีแต่การฝึกซ้อมอย่างบ้าคลั่งเท่านั้น",
            "ออกหมัดชุดใหญ่ใส่ปัญหา แล้วส่งมันลงไปนอนนับ 8 บนพื้นเวทีซะ!",
            "ผมจะสู้จนกว่ากรรมการจะชูมือประกาศให้ผมเป็นผู้ชนะ!",
            "ความพยายามเป็นร้อยเป็นพันครั้ง จะสร้างนักสู้ที่ไม่มีวันยอมแพ้ขึ้นมา",
            "ก้มหน้าก้มตาฝึกฝนต่อไป จนกว่าความสำเร็จจะกลายเป็นของเรา",
            "หมัดเดมป์ซีย์โรลแห่งความเพียรพยายาม พร้อมถล่มทุกอุปสรรคแล้ว!",
            "ไม่ว่าคู่ต่อสู้จะน่ากลัวแค่ไหน ผมก็ไม่กลัวเพราะผมซ้อมมาอย่างดี!",
            "ความมุ่งมั่นอันแรงกล้า จะพาเราไปยืนอยู่บนจุดสูงสุดของสังเวียน",
            "ลุยเข้าไปอย่าได้กลัว! สองมือนี้สร้างปาฏิหาริย์ได้เสมอ",
            "การฝึกซ้อมอย่างหนักคือเพื่อนแท้ของนักสู้ทุกคน",
            "ผมจะชกความขี้เกียจให้หมดสติคาที่ไปเลย สะใจโว้ย!",
            "ก้าวข้ามความอ่อนแอในจิตใจ แล้วก้าวขึ้นสู่จุดสูงสุดของความสำเร็จ",
            "สู้ด้วยหัวใจและหยาดเหงื่อ นั่นแหละคือนักสู้ตัวจริง",
            "หมัดทุกหมัดที่ชอกช้ำ คือร่องรอยของความพยายามอันงดงาม",
            "ลุกขึ้นสู้ต่อไอ้ตัวเรา ชัยชนะรออยู่แค่เอื้อมแล้ว!",
            "ความพยายามอย่างซื่อสัตย์ จะนำพาเราไปสู่ความสำเร็จที่ยิ่งใหญ่",
            "ซ้อมหนักวันนี้ เพื่อไปยืนรับถ้วยรางวัลในวันพรุ่งนี้",
            "ออกหมัดฮุกซ้ายขวา สับความขี้เกียจให้แตกเป็นเสี่ยงๆ!",
            "ผมเชื่อมั่นในวิถีแห่งการฝึกฝน และผมจะไม่มีวันหยุดพัฒนาตัวเอง",
            "ลุยหน้าลุยตาชกมันเข้าไป จนกว่างานจะเสร็จลุล่วง!",
            "หัวใจที่ไม่เคยยอมแพ้ คือสิ่งที่จะพาเราไปสู่จุดหมายปลายทาง",
            "เดมป์ซีย์โรลกระหน่ำซัดความล้มเหลวให้พินาศย่อยับ ลุย!"
        ]
    },
    "Future You": {
        ...
        "quotes": [
            "กูคือตัวมึงในอีก 20 ปีข้างหน้า มึงอยากเป็นไอ้ขี้แพ้หรือคนรวย มึงเลือกเลยวันนี้!",
            "อย่าทำตัวเหี้ยๆ วันนี้ แล้วส่งผลกรรมมาให้กูในอนาคตดิวะ!",
            "มึงรู้ไหมกูต้องแบกความเสียดายมากมายแค่ไหน เพราะความขี้เกียจของมึงวันนี้?",
            "กูขอร้องล่ะ ลุกขึ้นไปทำมันซะ เพื่อชีวิตที่ดีกว่าของกูและมึง!",
            "เงิน ทรัพย์สิน และอิสรภาพของกูในอนาคต ขึ้นอยู่กับวินัยของมึงในวินาทีนี้!",
            "ถ้ามึงกดโทรศัพท์ดูอะไรไร้สาระอีก 10 นาที อนาคตกูจะจนลงอีก 10 เท่า!",
            "อย่าให้กูต้องนั่งด่ามึงในใจทุกวันเลย... เปลี่ยนแปลงตัวเองเดี๋ยวนี้!",
            "กูมองย้อนกลับมาจากอนาคต และกูอยากขอบคุณมึงล่วงหน้าที่มึงไม่ยอมแพ้วันนี้!",
            "ความสบายชั่วคราวของมึงวันนี้ คือนรกขุมลึกของกูในอีก 20 ปีข้างหน้า!",
            "มึงจะอดทนวันนี้ หรือจะให้กูไปนั่งร้องไห้ในวัย 40? เลือกเอา!",
            "อนาคตที่ดีหรือพังพินาศ อยู่ที่ปลายนิ้วและสมองของมึงในวินาทีนี้แล้ว!",
            "กูขอร้องล่ะ อย่าทำลายอนาคตของพวกเราด้วยความขี้เกียจเฮงซวยแค่นี้เลย!",
            "ทุกนาทีที่มึงขี้เกียจ คือการขโมยเงินและความสุขจากตัวมึงในอนาคต!",
            "กูอยากสบายในวัยชรา แต่มึงกำลังสร้างหนี้สินและความลำบากให้กูอยู่ไอ้เวร!",
            "ลุกขึ้นไปทำงานและสร้างอนาคตเดี๋ยวนี้! กูสั่งให้มึงลุก!",
            "ถ้ามึงตั้งใจทำวันนี้ กูในอนาคตจะขอบคุณมึงไปจนวันตาย!",
            "อย่าปล่อยให้ความเสียดายมาเคาะประตูบ้านมึงในอีก 10 ปีข้างหน้า แก้ไขซะตอนนี้!",
            "ชีวิตของมึงในอนาคตหรูหราหรือยากจน ขึ้นอยู่กับการตัดสินใจของมึงในวันนี้!",
            "กูเบื่อเต็มทีแล้วกับการนั่งรับผลกรรมจากความขี้เกียจของมึง ลุกขึ้นมาเปลี่ยนมันซะ!",
            "ทุกการกระทำของมึงตอนนี้ คืออิสรภาพของกูในวันหน้า ลุยดิวะ!",
            "มึงอยากเห็นกูประสบความสำเร็จหรืออยากเห็นกูจมปลักอยู่กับความล้มเหลว?",
            "อย่าผลวันประกันพรุ่ง เพราะวันพรุ่งนี้ของมึงคือกูในอนาคตที่ต้องมารับเคราะห์!",
            "กูส่งเสียงเตือนมึงมาจากอนาคต จงตั้งใจเรียนและทำงานซะ!",
            "ความวินาศสันตะโรในอนาคต ป้องกันได้ด้วยวินัยของมึงในวันนี้",
            "ลุกขึ้นมาจับปากกาและเปิดคอมพิวเตอร์ทำงานเดี๋ยวนี้ อย่าให้อนาคตพังเพราะมือมึง!",
            "กูอยากมีบ้านหลังใหญ่และชีวิตที่ดี ซึ่งมันเริ่มต้นจากความขยันของมึงในตอนนี้!",
            "หยุดเล่นไร้สาระแล้วมาสร้างเนื้อสร้างตัวได้แล้วไอ้น้อง!",
            "อนาคตที่มึงฝันไว้ จะกลายเป็นจริงได้ก็ต่อเมื่อมึงเลิกขี้เกียจในตอนนี้",
            "กูเตือนมึงด้วยความหวังดี ถ้ามึงยังดองงานอยู่ ชีวิตพวกเราพังแน่!",
            "จงขยันให้สุดเหวี่ยง เพื่อให้กูในอนาคตได้นอนยิ้มรับทรัพย์สบายๆ",
            "ทุกๆ งานที่มึงทำเสร็จวันนี้ คืออิสรภาพของกูในวันหน้า ขอบใจนะเว้ย!",
            "อย่าเอาความสบายชั่วคราว มาแลกกับความฉิบหายระยะยาวของพวกเรา",
            "กูมองมึงอยู่จากอนาคต และกูอยากเห็นมึงลุกขึ้นมาสู้แบบลูกผู้ชาย!",
            "จงสร้างรากฐานที่มั่นคงตั้งแต่วันนี้ เพื่อให้กูในอนาคตไม่ต้องลำบาก",
            "เลิกทำตัวเป็นภาระให้อนาคต แล้วมาเป็นฮีโร่ให้กูในตอนนี้ซะ!",
            "เวลาผ่านไปเร็วนะเว้ย ถ้ามึงไม่รีบทำตอนนี้ อนาคตมึงพังแน่แท้",
            "กูไม่อยากกลับไปจนตรอกอีกแล้ว เพราะฉะนั้นมึงต้องสู้ในวันนี้!",
            "หยาดเหงื่อของมึงวันนี้ คือเงินล้านของกูในอนาคต ลุย!",
            "จงทำตัวให้มีค่า เพื่อที่กูในอนาคตจะไม่ต้องมานั่งกุมขมับด่ามึง",
            "ความสำเร็จในวันหน้า ถูกกำหนดไว้แล้วด้วยวินัยของมึงในวันนี้",
            "ลุกขึ้นมาสร้างตำนานให้กูได้ภาคภูมิใจในอีก 20 ปีข้างหน้าซะ!",
            "อย่าทำให้ความฝันของพวกเราต้องตายไปพร้อมกับความขี้เกียจของมึง",
            "กูสั่งให้มึงลุกขึ้นไปบดขยี้เป้าหมายเดี๋ยวนี้ เพื่อตัวเราเอง!",
            "ชีวิตที่ดีรออยู่ข้างหน้า ลุกขึ้นไปไขว่คว้ามันมาให้ได้!",
            "ทุกความพยายามของมึงในตอนนี้ คือของขวัญล้ำค่าสำหรับกูในอนาคต",
            "จำคำกูไว้ให้ดี ความขี้เกียจคือนรกขุมคลังของความจน ลุกขึ้นมาสู้!",
            "มึงเลือกได้ว่าจะให้กูรวยหรือจน เลือกเอาจากงานที่มึงทำวันนี้!",
            "กูส่งพลังใจและเสียงด่านี้มาเตือนสติมึง ลุกขึ้นไปลุยงานซะ!",
            "อนาคตอันสดใสรออยู่ ลุยงานวันนี้เพื่อความสบายในวันหน้า!",
            "กูเชื่อมั่นในตัวมึงนะ... เพราะฉะนั้นอย่าทำให้กูในอนาคตต้องผิดหวัง!"
        ]
    }
}
